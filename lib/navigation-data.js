...
export const desktopMenuItems = [
  ...
  { id: "nav-scooter", label: "Scooter", hasDropdown: true, url: "#" }, // Corrected spelling
  {
...
// Scooters (Adjust labels/images/urls as needed)
export const scootersDropdownItems = [
  ...
  },
  {
    ...
    url: "/vehicles/hermes-75",
  },
  // Add another scooter if available, or a placeholder link
  // { label: "KS1000", type: "model", image: "https://via.placeholder.com/370x208/DDDDDD/404040?text=KS1000", url: "/vehicles/ks1000" },
  { label: "Explore Features", type: "link", url: "/scooters/features" }, // Placeholder link
...
export const moreDropdownItems = [
  ...
  { label: "Careers", type: "link", group: 1, url: "/careers" }, // Example link
];
